...
const MODULES = [
  {
    ...
    hooks: [
      "People with zero design or writing background are landing ₦50k+ projects — using AI to do the heavy lifting.",
      "The 3 AI tools beginners are using to look like seasoned professionals from day one.",
      "A simple pricing trick that gets you your first paying client without years of experience.",
    ],
    Icon: Sparkles,
    points: [
  ...
  },
  {
    ...
    hooks: [
      "You can start selling online without spending a naira on stock — here's exactly how that works.",
      "The one supplier mistake that kills most first-time stores (avoid it and you're already ahead).",
      "A realistic first-month budget so you don't burn cash chasing ads blindly.",
    ],
    Icon: Package,
    points: [
  ...
  },
  {
    ...
    hooks: [
      "One platform, one post a day — the entire strategy quietly working for people building real income right now.",
      "Why chasing virality is the wrong goal, and what actually pays instead.",
      "The realistic timeline before content turns into real money — most people quit right before this point.",
    ],
    Icon: Video,
    points: [
  ...
  },
  {
    ...
    hooks: [
      "The slow, unglamorous approach that actually protects your money while it grows.",
      "One simple rule that stops most beginners from losing money in their first month.",
      "How to start small enough that a mistake won't hurt — but big enough to actually matter.",
    ],
    Icon: TrendingUp,
    points: [
  ...
  },
  {
    ...
    hooks: [
      "Your next paying customer is probably someone in your area you haven't met yet.",
      "The fastest, lowest-cost way to land your first job this month.",
      "A pricing method that stops you from underselling your own time and skill.",
    ],
    Icon: Wrench,
    points: [
  ...
  },
  {
    ...
    hooks: [
      "Earn steady income recommending things you already believe in — no product, no inventory.",
      "The one rule that builds trust instead of looking spammy to your audience.",
      "How small, focused audiences are quietly out-earning big, unfocused ones doing this.",
    ],
    Icon: Link2,
    points: [
        ...
        <div style={{ padding: "1.5rem 1.25rem", overflowY: "auto" }}>
          <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
            <div style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: "1.4rem", lineHeight: 1.3 }}>
              6 Proven Ways People Are Earning More <span style={{ color: C.gold }}>Right Now</span>
            </div>
            <div style={{ color: C.muted, fontSize: "0.85rem", marginTop: "0.5rem" }}>
              Full breakdown for each one — unlocked free in 2 minutes.
            </div>
          </div>
          ...
          <div style={{ textAlign: "center", color: C.muted, fontSize: "0.82rem", marginBottom: "1rem", lineHeight: 1.5 }}>
            I've got the full playbook for each one, plus tools to get started fast. Answer a few quick questions and I'll unlock your personalized plan.
          </div>
